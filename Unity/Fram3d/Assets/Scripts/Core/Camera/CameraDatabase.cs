...
namespace Fram3d.Core.Camera
{
    public sealed class CameraDatabase
    {
        ...
        private void AddGenericDefaults()
        {
            ...
            {
                new CameraBody("Generic 35mm",    "Generic", 0, 36.0f,  24.0f,  "FF",   "", new[] { 4096, 2160 }, new[] { 24, 25, 30, 48, 60 }),
                new CameraBody("Generic Super 35", "Generic", 0, 24.89f, 18.66f, "S35",  "", new[] { 4096, 2160 }, new[] { 24, 25, 30, 48, 60 }),
                new CameraBody("Generic 16mm",    "Generic", 0, 10.26f, 7.49f,  "16mm", "", new[] { 1920, 1080 }, new[] { 24, 25, 30 }),
                new CameraBody("Generic Super 16", "Generic", 0, 12.52f, 7.41f,  "S16",  "", new[] { 1920, 1080 }, new[] { 24, 25, 30 }),
                new CameraBody("Generic 8mm",     "Generic", 0, 4.5f,   3.3f,   "8mm",  "", new[] { 1920, 1080 }, new[] { 24, 25, 30 }),
            });
