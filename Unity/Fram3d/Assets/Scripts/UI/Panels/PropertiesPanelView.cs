...
namespace Fram3d.UI.Panels
{
    ...
    public sealed class PropertiesPanelView: MonoBehaviour
    {
        ...
        private void BuildPanel()
        {
            ...
            this._panel.style.backgroundColor = new Color(0.145f, 0.145f, 0.145f, 1f); // #252525
            this._panel.style.borderLeftWidth = 1;
            this._panel.style.borderLeftColor = new Color(0.235f, 0.235f, 0.235f, 1f); // #3c3c3c
        ...
        private void BuildHeader()
        {
            ...
            header.style.backgroundColor = new Color(0.118f, 0.118f, 0.118f, 1f); // #1e1e1e
            header.style.borderBottomWidth = 1;
            header.style.borderBottomColor = new Color(0.235f, 0.235f, 0.235f, 1f); // #3c3c3c
