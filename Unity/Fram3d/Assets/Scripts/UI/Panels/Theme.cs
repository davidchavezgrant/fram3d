...
namespace Fram3d.UI.Panels
{
    ...
    public static class Theme
    {
        ...
        public static readonly Color BORDER = new(0.235f,
                                                  0.235f,
                                                  0.235f,
                                                  1f); // #3c3c3c

        public static readonly Color DROPDOWN_BG = new(0.16f,
                                                       0.16f,
                                                       0.16f,
                                                       1f);

        public static readonly Color HEADER_BACKGROUND = new(0.118f,
                                                             0.118f,
                                                             0.118f,
                                                             1f); // #1e1e1e
        ...
        public static readonly Color LABEL_BRIGHT = new(0.733f,
                                                        0.733f,
                                                        0.733f,
                                                        1f); // #bbb

        public static readonly Color LABEL_DIM = new(0.4f,
                                                     0.4f,
                                                     0.4f,
                                                     1f); // #666

        public static readonly Color LABEL_MID = new(0.6f,
                                                     0.6f,
                                                     0.6f,
                                                     1f); // #999

        // --- Colors ---
        public static readonly Color PANEL_BACKGROUND = new(0.145f,
                                                            0.145f,
                                                            0.145f,
                                                            1f); // #252525

        public static readonly Color SELECTOR_BG = new(0.18f,
                                                       0.18f,
                                                       0.18f,
                                                       1f);

        public static readonly Color SELECTOR_BORDER = new(0.3f,
                                                           0.3f,
                                                           0.3f,
                                                           1f);
        ...
        public static readonly Color TEXT_LIGHT = new(0.8f,
                                                      0.8f,
                                                      0.8f,
                                                      1f);
