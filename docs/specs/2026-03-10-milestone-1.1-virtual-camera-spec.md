...
- ### 1.1. Virtual camera (Milestone)
  ...
  - ##### 1.1.3. Camera body and lens presets (Feature)
    ...
    **Functional requirements:**
    - Camera body presets, each defining a sensor width and height in millimeters:
      ...
      - Super 16mm
      - 8mm
    - Lens set presets, each defining a list of available focal lengths. Presets distinguish prime vs. zoom lenses. Prime lenses have a single fixed focal length. Zoom lenses cover a continuous range (e.g., 24-70mm). Focal length keyframing is only available for zoom lenses -- a prime lens is always at its fixed focal length:
      - Zeiss Master Prime (prime): 14, 18, 21, 25, 28, 32, 35, 40, 50, 65, 75, 85, 100, 135, 150mm
      - Cooke S4/i (prime): 14, 18, 21, 25, 27, 32, 35, 40, 50, 65, 75, 100, 135, 150, 180mm
      - Leica Summilux-C (prime): 16, 18, 21, 25, 29, 35, 40, 50, 65, 75, 100, 135mm
      - Sigma Cine FF (prime): 14, 20, 24, 28, 35, 40, 50, 85, 105, 135mm
      - Generic Prime (prime): 14, 18, 21, 24, 28, 35, 50, 65, 75, 85, 100, 135, 150, 200, 300, 400mm
  ...
  - ##### 1.1.6. Camera shake (Feature)
    ...
    **Functional requirements:**
    ...
    - Shake is cosmetic only -- it is not recorded by auto-keyframing. It is baked to keyframes only during export. During interactive use and playback, shake is a preview effect layered on top of the camera animation data.
