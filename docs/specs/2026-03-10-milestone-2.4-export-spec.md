  ...
  *Blocked by: 1.5 (keyframe animation --- need playback to render video)*
  ...
  - ##### 2.4.1. Image export (Feature)
    ...
    **Functional requirements:**
    ...
    - The image is cropped to the camera's configured resolution --- no black bars. The camera resolution is set at project creation time and becomes the "project resolution." This resolution is configurable in project settings.
