  ...
  *Blocked by: 1.5 (keyframe animation --- need playback to render video)*
  ...
  - ##### 2.4.2. Video export (Feature)
    ...
    **Functional requirements:**
    ...
    - When rendering the full sequence, shots are concatenated in sequencer order with hard cuts only --- no dissolves, fades, or transitions
    ...
    **Expected behavior:**
    ``` python
      ...
      # full sequence render with hard cuts
