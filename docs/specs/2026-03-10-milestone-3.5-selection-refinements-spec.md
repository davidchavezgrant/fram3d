# Milestone 3.5: Selection and Manipulation Refinements
	...
	*Blocked by: 1.3 (scene management -- selection and gizmos must exist), 1.5 (keyframe animation -- curves apply to keyframes)*
	...
	- ##### 3.5.3. Custom interpolation curves (Feature)
		...
		*Related:
		...
		- 1.5.3 (keyframe interaction -- curve type is a property of a selected keyframe, configurable per animated property)*
