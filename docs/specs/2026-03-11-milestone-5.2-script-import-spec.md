# Milestone 5.2: Script Import

**Date**: 2026-03-11
**Status**: Resolved
**Milestone**: 5.2 — Script import (HIGHER PRIORITY)
**Project**: 5 — Feature parity and extensions
**Related**: 2.2.5 (Multi-scene project structure), 1.2.4 (Subtitle overlay)

---

- ### 5.2. Script import (Milestone)
	*Import screenplays to auto-populate scenes, characters, and dialogue. Bridges the gap between script and previs.*
	...
	- ##### 5.2.1. Script parsing (Feature)
		...
		**What does NOT get imported (v1):**
		- Action lines do NOT auto-place objects or characters (that's Project 4 — AI blocking)
		...
		**Multi-scene interaction:**
		- Each scene heading creates a separate scene tab (per 2.2.5 multi-scene project structure)
		- Character definitions are project-level; character state (pose, position) is scene-level

		**Future enhancement:**
		- Connect to Project 4 (AI blocking): after import, offer "Auto-block this scene?"
