# Milestone 5.6: Costume Generation

**Date**: 2026-03-11
**Status**: Resolved
**Milestone**: 5.6 — Costume generation (LOWER PRIORITY)
**Project**: 5 — Feature parity and extensions
**Blocked by**: 3.2 (Characters — costumes apply to mannequin mesh)
**Related**: 5.5 (AI prop generation — similar AI pipeline)

---

- ### 5.6. Costume generation (Milestone)
	*Generate 3D clothing meshes on existing mannequin. Clothing-on-mannequin approach — skeleton stays fixed, auto-binding to known skeleton is tractable. Supplements non-AI mannequin customization (3.2.1).*
	...
	- ##### 5.6.1. AI costume generation (Feature)
		...
		**Relationship to non-AI customization (3.2.1):**
		- 3.2.1 provides extensive non-AI mannequin customization (clothing presets, hair, accessories, skin tone — see Characters spec)
