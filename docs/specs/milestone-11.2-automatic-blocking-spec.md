...
- ### 11.2. Automatic blocking (Milestone)
  ...
  Position actors and objects from a scene description. This is the spatial reasoning counterpart to shot description (11.1) — instead of telling the system where to put the camera, the director tells it where to put the actors.
  ...
  *Blocked by: 6.1 (characters — automatic blocking places and poses characters)*
  ...
  - ##### 11.2.1. Scene-from-text (Feature)
    ...
    **Functional requirements:**
    ...
    - Placed mannequins are standard character objects from the character system (6.1) — they support posing, animation, and all existing scene interactions
    - Props and furniture referenced in the description are placed using objects from the built-in asset library (7.2.1) when a match exists
    ...
    - The result is a single atomic action in the undo stack (4.1) — one undo removes all placed objects from that generation
