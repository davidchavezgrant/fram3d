...
- ### 2.1. Scene management (Milestone)
	...
	*Blocked by: 1.1 (virtual camera — need a viewport and camera to interact with objects)*
	...
	- ##### 2.1.2. Transform gizmos (Feature)
		...
		*Related:
		- 2.2.2 (keyboard shortcuts — Q/W/E/R switch gizmo modes)*
	...
	- ##### 2.1.4. Object duplication (Feature)
	...
	- ##### 2.1.5. Director view (Feature)
		...
		*Related:
		...
		- 3.2.3 (per-track stopwatch — object transforms in director view still create keyframes when the stopwatch is on)
