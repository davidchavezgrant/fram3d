# Milestone 3.9: Multi-camera

**Date**: 2026-03-10
**Status**: Draft
**Blocked by**: 1.5 (Keyframe animation), 1.4 (Shot sequencer), 3.6 (Object linking — cameras are scene entities)
...
- ### 3.9. Multi-camera (Milestone)
  ...
  - ##### 3.6.2. Multi-camera timelines (Feature)
    ...
    *Related:
    ...
    - 1.5.3 (per-track stopwatch -- keyframes created when stopwatch is on)*
