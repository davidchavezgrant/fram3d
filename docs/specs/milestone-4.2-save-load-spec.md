# Milestone 4.2: Save / Load — Specification

**Date**: 2026-03-10
**Milestone**: 4.2
**Status**: Draft
**Blocked by**: 4.1 (Undo / Redo — dirty state tracking integrates with the undo stack)

---

- ### 4.2. Save / Load (Milestone)
  ...
  *Blocked by: 4.1 (undo/redo — save integrates with undo stack for dirty tracking)*

  - ##### 4.2.1. Project creation wizard (Feature)
  ...
  - ##### 4.2.3. Save / Load UI (Feature)
    ...
    **Functional requirements:**
    ...
    - **Open** (Cmd+O): prompts the user to select a project file. If the current project has unsaved changes, prompts to save first (see 4.2.3).
  ...
  - ##### 4.2.4. Dirty state tracking (Feature)
