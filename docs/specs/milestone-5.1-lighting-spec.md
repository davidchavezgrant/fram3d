# Milestone 5.1: Lighting — Specification

**Date**: 2026-03-10
**Milestone**: 5.1
**Status**: Draft
**Project**: Phase 5 — Environment

---

- ### 5.1. Lighting (Milestone)
	...
	*Blocked by: 3.2 (keyframe animation — light animation uses the timeline system)*
	...
	- ##### 5.1.1. Light types (Feature)
		...
		*Related:
		...
		- 2.1.2 (transform gizmos — lights use the same gizmo system)
		- 5.1.2 (light properties — each type has different configurable properties)*
	...
	- ##### 5.1.3. Light animation (Feature)
		...
		*Blocked by:
		- 3.2 (keyframe animation — light animation uses the timeline system)
		- 5.1.1 (light types — must have lights to animate)
		...
		**Functional requirements:**
		...
		- Light keyframes are selectable, draggable, and deletable using the same keyframe interaction model (3.2.4)
