# Milestone 5.2: Set Decoration Library
...
- ### 5.2. Set decoration library (Milestone)
	...
	*Blocked by: 4.3 (asset import — marketplace integration builds on the import pipeline established by model import and the basic asset library panel)*

	---

	- ##### 5.2.1. Built-in asset library (Feature)
		...
		*Related:
		- 4.3.2 (asset library panel — built-in assets appear alongside imported assets)
		- 2.1.1 (scene elements — placed assets become interactive scene elements with colliders)
		- 2.1.2 (transform gizmos — placed assets can be moved, rotated, and scaled immediately)*
	...
	- ##### 5.2.2. Marketplace integration (Feature)
		...
		*Blocked by:
		- 4.3.1 (model import — marketplace assets require format conversion and collider generation)
		- 5.2.1 (built-in asset library — marketplace assets integrate into the same browsing UI)*

		*Related:
		- 5.2.3 (user asset management — downloaded marketplace assets can be organized into collections)*
	...
	- ##### 5.2.3. User asset management (Feature)
		...
		*Related:
		- 5.2.1 (built-in asset library — built-in assets can be favorited and added to collections)
		- 5.2.2 (marketplace integration — downloaded marketplace assets appear in the user's asset inventory)
		- 4.3.1 (model import — user-imported assets are managed here)*
