# Milestone 6.3: Object Linking & Grouping
...
- ### 6.3. Object linking & grouping (Milestone)
	...
	*Blocked by: 2.1 (scene management — linking extends the scene object model), 3.2 (keyframe animation — link/unlink events live on the global timeline)*

	---

	- ##### 6.3.1. Object Linking (Feature)
		...
		*Related:
		- 6.3.2 (object grouping — persistent multiselect, separate from temporal linking)
		- 6.3.3 (object list panel — pickwhip tool for linking, shows link state)
		...
		**Panel interaction (pickwhip):**
		- In the object list panel (6.3.3), the user can drag a pickwhip connector from a child to a parent to create a link at the current playhead time
	...
	- ##### 6.3.2. Object Grouping (Feature)
		...
		*Related:
		...
		- 2.1.1 (scene elements — grouped objects are still independent scene elements)
	...
	- ##### 6.3.3. Object List Panel (Feature)
