# Milestone 7.1: Facial Expressions

**Date**: 2026-03-11
**Status**: Resolved
**Milestone**: 7.1 — Facial expressions
**Phase**: 7 — Character Extensions
**Blocked by**: 6.1 (Characters — expressions apply to character meshes)

---

- ### 7.1. Facial expressions (Milestone)
	*Blend shape-based facial expressions on characters. Presets, intensity control, keyframeable. Adds emotional context to blocking.*
	...
	- ##### 7.1.1. Expression system (Feature)
	...
	- ##### 7.1.3. Expression animation (Feature)
		*Expression track as a sub-track under the character's track in the timeline.*
		...
		- Independent of position/pose keyframing (follows per-track stopwatch model from 3.2.3)
